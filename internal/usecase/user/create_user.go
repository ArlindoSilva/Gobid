...
func (req CreateUserReq) Valid(ctx context.Context) validator.Evaluator {
	...
	eval.CheckField(
		...
		validator.MaxChars(req.Bio, 255), "bio", "this field must have between 10 and 255 characters")
	eval.CheckField(validator.MinChars(req.Password, 8), "password", "this field must be bigger than 8 chars")
